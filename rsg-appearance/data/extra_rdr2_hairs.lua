-- ==========================================
-- Дополнительные причёски RDR2/RDO
-- Стили, отсутствующие в базовом hairs_list
-- ==========================================
...
-- Добавляет недостающие стили в hairs_list
local function MergeExtraRDR2Hairs(hairs_list)
    -- Male: 026, 027 (часто отсутствуют или с пустыми hashname)
    ...
    -- Female: 029, 030 (RDO-update причёски, если есть в игре)
