...
local categoryLabels = {
    ...
    ['earrings'] = 'Серьги',
    ['talisman_belt'] = 'Талисман на пояс',
    ['body_shape_mp_waist'] = 'Тело: талия/живот (MP)',
    ['body_shape_mp_torso'] = 'Тело: верх (MP)',
    ['body_shape_p0_waist'] = 'Тело: талия (player_zero)',
    ['body_bodies_lower'] = 'Тело: низ (BODIES_LOWER)',
    ['body_bodies_upper'] = 'Тело: верх (BODIES_UPPER)',
}
...
-- ==========================================
-- МАППИНГ МАГАЗИНОВ ОДЕЖДЫ → КАЗНА ГОРОДА (shiw-government)
-- ==========================================
...
RegisterNetEvent('rsg-clothingstore:server:buyItem', function(item, storeId, isMale)
    ...
    -- ★ Пополнение казны города (shiw-government)
