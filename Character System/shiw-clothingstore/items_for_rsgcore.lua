...
['clothing_boot_accessories']   = {['name'] = 'clothing_boot_accessories',  ['label'] = 'Аксессуары для обуви',   ['weight'] = 80,   ['type'] = 'item', ['image'] = 'clothing_spurs.png',            ['unique'] = true, ['useable'] = true, ['shouldClose'] = true, ['description'] = 'Аксессуары для сапог'},
...
['clothing_talisman_belt']      = {['name'] = 'clothing_talisman_belt',     ['label'] = 'Талисман (ремень)',      ['weight'] = 50,   ['type'] = 'item', ['image'] = 'clothing_accessories.png',      ['unique'] = true, ['useable'] = true, ['shouldClose'] = true, ['description'] = 'Талисман на ремень'},
